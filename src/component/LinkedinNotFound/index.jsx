  ...
  return (
    <div className=" bg-white flex flex-col justify-center h-full relative p-3">
      <div
        ...
        className="border border-white bg-white h-auto rounded-2xl w-full relative z-10 p-2 backdrop-blur-md"
      >
        <div className="bg-white rounded-2xl h-full w-full flex flex-col justify-center items-center px-7 py-6">
          <h1
            className="text-center text-base non-italic font-bold"
            style={{
              fontFamily: "Comfortaa",
              color: "#D65D5B",
            }}
          >
            There is no account found to connect.
          </h1>

          <p
            className="text-sm non-italic font-medium my-4"
            style={{
              fontFamily: "Quicksand",
              color: "#084649",
            }}
          >
            It seems like you have not logged in with any of your accounts in
            the browser.{" "}
            <a
...
export default LinkedinNotFound;
